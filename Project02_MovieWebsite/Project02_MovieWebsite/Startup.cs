...
[assembly: OwinStartup(typeof(Project02_MovieWebsite.Startup))]

namespace Project02_MovieWebsite
{
    public class Startup
    {
        ...
        public void CreateRoleAndUser()
        {
            ...
            if (userManager.FindByName("admin") == null)
            {
                ...
                var ckdUser = userManager.Create(user, userPwd);
                if (ckdUser.Succeeded)
                {
